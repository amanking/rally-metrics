...
describe "Revisions parser" do
  it "should return schedule with development start date" do
    schedule = RevsParser.new.parse(['2013-04-16T04:36:22.762Z | SCHEDULE STATE changed from [Defined] to [In-Progress]'])
  ...
  it "should return empty schedule if revision does not involve state change" do
    schedule = RevsParser.new.parse(['2013-04-16T04:36:22.762Z | blah blah blah'])
